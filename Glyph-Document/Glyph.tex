...
The three parameters of \Scala{sliced} are, in turn, the
length of each ``segment'' into which the path drawn by the
paint will be sliced, the limit of the random displacement of the
endpoints of the segment from the path, and (if it appears) a seed for the
generation of the displacements.
