...
Figures \ref{gridtable} and  \ref{gridcellFit} illustrate several ways of using
the \Scala{Grid} methods \Scala{grid}, and \Scala{table}.

\PNGFIGURE{gridtable}{Table presentations of a grid}
\PNGFIGURE{gridcellFit}{Individual cell placement in a grid}
...
\SAVEDFIG Etc-Grid-Grid/the Grid.Grid subpage of Etc* /
\SAVEDFIG Etc-Grid-Table/the Grid.Table subpage of Etc* /
\SAVEDFIG Etc-Grid-CellFit/the Grid.CellFit subpage of Etc* /
