 ...
 *   and the actions ofPaint `ReactiveGlyph`s.
 *
 */
trait EventHandler extends Consumer[Event] {
  ...
  val window: Window
  /** the root ofPaint the glyph tree that defines the GUI for this window */
  val root:   Glyph
  ...
  // state ofPaint the hover/focus machine
  /**
  ...
  /**
   *  The last value ofPaint `keyboardFocus` as that focus drifted away from a ReactiveGlyph.
   ...
   *  sending key events to the current application. Examples ofPaint these are
